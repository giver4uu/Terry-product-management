...
**정량적 임팩트 (추정):**
- **계약 전환율**: +5%p (대표/임원이 직접 관여하는 중소기업 타겟)
  - 근거: 영업 파이프라인에서 "대표님이 평가에 참여하고 싶은데, 알림이 너무 많아서 거부감이 있다"는 피드백이 월 2-3건 발생 중
- **NPS 개선**: +15점 (대표 및 고위 의사결정권자 그룹)
- **CS 문의 감소**: 월 평균 8건 → 3건 (-62%)
  - "대표 권한을 어떻게 설정하나요?", "알림을 끌 수 없나요?" 등의 문의가 현재 주 2건 발생
