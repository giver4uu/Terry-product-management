                    ...
                    <div className="group relative flex flex-col items-center justify-center">
                        <div
                            className={cn(
                                ...
                                selected
                                    ? "w-6 h-6 ring-4 z-50 scale-110 " + (data.kind === 'property' ? "bg-amber-400 ring-amber-500/30" : "bg-blue-400 ring-blue-500/30")
                                    : "group-hover:scale-125 " + (data.kind === 'property' ? "group-hover:bg-amber-400" : "group-hover:bg-blue-400")
                            )}
                        >
                        ...
                        <div className={cn(
                            ...
                            {data.label}
                            {data._metadata?.originalRequired && <span className="text-red-500 ml-0.5">*</span>}
                        </div>
                    </div>
                </Tooltip.Trigger>
                <Tooltip.Portal>
                    ...
                    >
                        ...
                        {data._metadata ? (
                            <>
                                <div className="text-[10px] text-slate-400">Type: {data._metadata.originalType}</div>
                                <div className="text-[10px] text-slate-400">Required: {data._metadata.originalRequired ? 'Yes' : 'No'}</div>
                            </>
                        ) : (
